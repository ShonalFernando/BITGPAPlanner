...
namespace UnitTester.Model
{
    public class Subject
    {
        ...
        public void AddSubject(string connectionString, Subject subject)
        {
            using (var connection = new SQLiteConnection(connectionString))
            {
                connection.Open();
        ...
        public void AddSubjectsBulk(string connectionString, List<Subject> subjects)
        {
            using (var connection = new SQLiteConnection(connectionString))
            {
                connection.Open();
        ...
        public List<Subject> GetAllSubjects(string connectionString)
        {
        ...
        public List<Subject> GetSubjectsByLevel(string connectionString, int level)
        {
            List<Subject> subjects = new List<Subject>();
        ...
        public Subject? GetSubjectById(string connectionString, int subjectId)
        {
            using (var connection = new SQLiteConnection(connectionString))
            {
                connection.Open();
        ...
        public Subject? GetSubjectByCode(string connectionString, string subjectCode)
        {
            using (var connection = new SQLiteConnection(connectionString))
            {
                connection.Open();
        ...
        public int GetGPACreditsByCode(string connectionString, string subjectCode)
        {
            using (var connection = new SQLiteConnection(connectionString))
            {
                connection.Open();
